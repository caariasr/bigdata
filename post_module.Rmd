...
+ ** TALK ABOUT HOW WE SPLITTED THIS TABLE INTO HOUSING CALLS AND RESTAURANT CALLS AND THE ROLE THE NYC OPEN DATA WEBSITE PLAYED HERE... AND ALSO TO MENTION THE EXTERNAL TABLES ADDED TO THE ANALYSIS**
...
renderPlot({
    ...
    ylab <- ifelse(var == "housing_calls", "Number of 311 calls related to housing",
                   "Number of housing violations")
    allbyzip %>% 
    ggplot(aes(x=restaurant_calls, y=allbyzip[, var])) +
    geom_point() +
