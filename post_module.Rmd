...
View 2 labeled housingcallsbyzipmonth referenced the nyc311callscleaned database to filter housing_calls by location_type to include locations with strings that had the words "residentail", "family", and "private house". Once this filter was applied to the housing_calls, the data was then grouped by zipcode and month.
