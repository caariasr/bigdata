...
renderPlot({
  ...
  monthsSelected <- month.name[input$month3[1]:input$month3[2]]
  allbyzipmonth %>%
      filter(month %in% monthsSelected & population > 2000) %>%
      ggplot(aes(x=population, y=allbyzipmonth[, var])) +
...
renderPlot({
  ...
  monthsSelected <- month.name[input$month4[1]:input$month4[2]]
